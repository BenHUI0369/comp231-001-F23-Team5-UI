...
export default function Dashboard() {
  ...
  const [variable, setVariable] = React.useState(true); // Variable to be accessed and modified

  const toggleVariable = () => {
    setVariable(!variable); // Invert the value of the variable
  };
        ...
        >
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={8} lg={6} sx={{display: variable? 'block': 'none'}}>
                <Paper
                  sx={{
                    p: 2,
                    display: 'flex',
